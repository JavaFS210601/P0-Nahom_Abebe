...
switch(input) {
			...
			case "Players": {
				...
				//List of player that gets populated by the getplayers method in our AstrolgyDao
			...
			case "Add": {
				...
				//String birth_date = scan.nextLine();
				 ...
				 //because without any nextLine, your enter keystroke will be grabbed as the next input
				
				//Given all this information, we'll create a new player object to send to a DAO method
				//This is using the all-args minus employee_id constructor
				Player newPlayer = new Player(player_Id,f_name, l_name, "xxxx-xx-xx"); //placeholder for hire_date, will be changed
